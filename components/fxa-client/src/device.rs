...
impl FirefoxAccount {
    ...
    /// Ensure that our own device is registered and the
    /// send tab command is also registered.
    ///
    /// **💾 This method alters the persisted account state.**
    pub fn ensure_device_registered(&mut self, device_type: Type, name: &str) -> Result<()> {
